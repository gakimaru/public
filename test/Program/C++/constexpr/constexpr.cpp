...
//CRCテスト①
//http://www.codeproject.com/Tips/627020/constexpr-CRC32-using-user-defined-literal
namespace crc_test1
{
...
{
	return crc_test1::crc32_helper(v, c, 0xFFFFFFFF);
}

//CRCテスト②
//http://d.hatena.ne.jp/iorate/20110115/1295108835
namespace crc_test2
{
...
constexpr auto hash_test2 = &crc_test2::checksum;
...
int main(const int argc, const char* argv[])
{
	...
	{
		const unsigned int crc1 = "caracoles"_crc32;
		const unsigned int crc2 = "1234567890"_crc32;
		static_assert(crc1 == 0x0A6573FF, "CRC32 calculation problem!");
		printf("TEST1:crc=0x%08x\n", crc1);
		printf("TEST1:crc=0x%08x\n", crc2);
	}
	
	{
		const unsigned int crc1 = hash_test2("caracoles");
		const unsigned int crc2 = hash_test2("123456789");
		static_assert(crc2 == 0x29B1, "crc error");
		printf("TEST2:crc=0x%08x\n", crc1);
		printf("TEST2:crc=0x%08x\n", crc2);
	}
